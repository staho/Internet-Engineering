	  ...
	  _createClass(InfiniteScroll, [{
	    ...
	    value: function render() {
	      ...
	      // on drag down as overflow becomes visible
				...
				var outerDivStyle = this.props.pullDownToRefresh ? { overflow: "auto" } : {}
				outerDivStyle = this.props.height ? { overflow: "auto", height: this.props.height } : {};
				// console.log(outerDivStyle)	
